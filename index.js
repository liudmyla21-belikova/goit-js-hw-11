import{a as u,S as p,i as a}from"./assets/vendor-CrlV4O_2.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&c(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function c(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const d="50801128-9bde19728bc3e6666ae5ca17b";function f(n){const s=new URLSearchParams({key:d,q:n,image_type:"photo",orientation:"horizontal",safesearch:!0});return u(`https://pixabay.com/api/?${s}`)}const l=document.querySelector(".gallery");let m=new p(".gallery a");const i=document.querySelector(".loader");i.style.display="none";function y(n){const s=n.map(r=>`
     ...
     <p class="text">Likes<span class="span">${r.likes}</span></p>
      ...
      </li>`).join("");l.insertAdjacentHTML("beforeend",s),m.refresh()}function h(){l.innerHTML=""}function g(){i.style.display="block"}function L(){i.style.display="none"}const b=document.querySelector(".form"),w=document.querySelector('input[name="search-text"]');b.addEventListener("submit",S);function S(n){n.preventDefault();const s=w.value.trim();if(!s){a.warning({message:"Please enter a search query"});return}h(),g(),f(s).then(({data:r})=>{r.hits.length>0?y(r.hits):a.info({message:"Sorry, there are no images matching your search query."})}).catch(r=>{a.error({message:"Sorry, there are no images matching your search query. Please try again!"})}).finally(()=>{L()})}
